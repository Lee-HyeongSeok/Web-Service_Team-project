...
<div class="container pt-3">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <!-- 댓글 작성 -->
            <label>
                <span>댓글 작성</span><textarea placeholder="메시지를 남겨주세요" width=80 height=30></textarea>
            ...
            <div>
                <button onclick="updatePostEventListener(<%=postId%>);">수정</button>
                <button onclick="removePostEventListener(<%=postId%>);">삭제</button>
            </div>
            <%}%>
        </div>
        <!-- footer -->
